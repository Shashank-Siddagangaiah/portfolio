...
into #base_data
from #view_ph ph
left join AWM.dbo.party_id_same_as_link pil
    on ph.party_key = pil.party_anchor_id_master
left join AWM.dbo.party_anchor pta
    on pil.party_anchor_id_duplicate = pta.party_anchor_id
;
